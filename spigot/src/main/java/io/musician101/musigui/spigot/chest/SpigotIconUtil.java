...
public final class SpigotIconUtil {
    ...
    public static ItemStack addLore(@Nonnull ItemStack itemStack, @Nonnull String lore) {
        return addLore(itemStack, List.of(lore));
    }

    public static ItemStack addLore(@Nonnull ItemStack itemStack, @Nonnull List<String> lore) {
        getMeta(itemStack, ItemMeta.class).ifPresent(m -> {
    ...
    public static ItemStack customName(@Nonnull ItemStack itemStack, @Nonnull String name) {
        getMeta(itemStack, ItemMeta.class).ifPresent(m -> {
